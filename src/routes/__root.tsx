...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Boutique design–build studio for private estates and architectural gardens." },
      { name: "author", content: "SeasonsLandscapers" },
    ],
    links: [
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <main className="bg-ambient grain relative min-h-screen">
        <Nav />
        <Outlet />
        <Footer />
        <Toaster />
